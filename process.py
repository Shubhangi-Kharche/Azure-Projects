...
hostname = 'mysql24.mysql.database.azure.com'
username = 'shubhangi24@mysql24'
password = 'kharche24*'
database = 'testdb'

def main():
    connect_str = "DefaultEndpointsProtocol=https;AccountName=skblob24;AccountKey=y3AlYSTVFt/rK3SgUoxMPhxQzlEkgZY4c0lKZ4Rem4nQnD3mE/HptjVi50Zp8clpBIuNFOYoAyOs+AStr31bCA==;EndpointSuffix=core.windows.net"
